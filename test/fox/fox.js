...
const filePath = path.join(folderPath, 'fox-item-links-data.json');
let scrapingLinks = "";
let dataExist = true;
...
(async () => {
    ...
    const url = 'https://foxflannel.com/collections/vintage-fox';
    ...
    const browser = await puppeteer.launch({
        ...
        const itemGridSelector = '#snize-search-results-grid-mode .snize-search-results-content > li';
        ...
        for(const productHandle of productsHandles){
            ...
            try{
                ...
                const productUrl = 'https://foxflannel.com'+ await page.evaluate(el => el.querySelector("a").getAttribute('href'), productHandle);
                /*
